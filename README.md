...
The following command descriptions were generated by `describe-scripnix` on November 1, 2016.
...
Options:
  -n, --no-translate  Do not translate the original operating system string to
