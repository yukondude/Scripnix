...
|buildstatus| |codecov| |pypiversion| |licence| |pyversions| |status|
...
.. |pypiversion| image:: https://badge.fury.io/py/Scripnix.svg
   :target: https://badge.fury.io/py/Scripnix
.. |licence| image:: https://img.shields.io/pypi/l/Scripnix.svg
   :target: https://img.shields.io/pypi/l/Scripnix.svg
.. |pyversions| image:: https://img.shields.io/pypi/pyversions/Scripnix.svg
   :target: https://img.shields.io/pypi/pyversions/Scripnix.svg
.. |status| image:: https://img.shields.io/pypi/status/Scripnix.svg
   :target: https://img.shields.io/pypi/status/Scripnix.svg
